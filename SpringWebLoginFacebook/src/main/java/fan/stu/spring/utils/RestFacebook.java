...
public class RestFacebook {
    public static String FACEBOOK_APP_ID = "780394086054885";
    public static String FACEBOOK_APP_SECRET = "8d107087d22ee9d799b5a54bb9d376d1";
    public static String FACEBOOK_REDIRECT_URL = "https://localhost:8443/SpringWebLoginFacebook/login-facebook";
